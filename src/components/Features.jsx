    ...
    <Grid id='features'>
        <Box id='button container' width='100%'>
            <Box sx={{display: 'flex', flexDirection: 'row', justifyContent: 'center', width: '100%', mb: 20}}>
                <Box id='buttons' component='img' src={mac} onClick={() => window.open('http://www.google.com')} sx={{width: '100px', height: '100px'}}></Box>
                <Box id='buttons' component='img' src={microsoft} sx={{width: '100px', height: '100px'}}></Box>            
            </Box>
        </Box>
        <Box id='feature1' sx={{display: 'flex', flexDirection: 'row-reverse', justifyContent: 'space-evenly', alignItems: 'flex-start', alignContent: 'center', mb: 20}}>
            ...
            <Typography
                ...
                >                
                Take command of the command line interface with our pre-cofigured kubectl options, or free type commands into our CLI
                </Typography>
                <Typography
                variant='h6'
                sx={{
                ...
                >                
                Clearly visualize your commands within our interactive terminal, and take advantage of the increased readability
                </Typography>
            </Box>
        ...
        <Box id='feature2' sx={{display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'flex-start', alignContent: 'center', mb: 20}}>
            <Box sx={{width: '45%', display: 'flex', flexDirection: 'column', justifyContent:'space-around', alignItems: 'flex-end'}}>
            <Typography
                variant='h3'
                sx={{
                    fontFamily: 'Roboto',
                ...
                >                       
                Kickstart your project by creating your own docker image or uploading an image using our easy setup configuration
                </Typography>
                <Typography
                variant='h6'
                sx={{
                ...
                >Generate a custom YAML file personalized to your projects' needs using a pre-configured template, allowing you to shorten tedious setup time and start working with your clusters
                </Typography>
            </Box>
